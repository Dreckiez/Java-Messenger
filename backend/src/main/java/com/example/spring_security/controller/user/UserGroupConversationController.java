...
public class UserGroupConversationController {
    ...
    public ResponseEntity<Map<String, Object>> createGroup(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(userGroupConversationService.createGroup(user.getUserId(), createGroupRequest));
    }
    ...
    public ResponseEntity<ListGroupConversationMessageResponse> getMessages(
        ...
        return ResponseEntity.ok(userGroupConversationService.getMessages(user.getUserId(), groupConversationId, cursorId));
    }
    ...
    public ResponseEntity<Map<String, String>> updateAvatar(
        ...
        return ResponseEntity.ok(userGroupConversationService.updateAvatar(user.getUserId(), groupConversationId, avatar));
    }
    ...
    public ResponseEntity<Map<String, String>> add(
        ...
        return ResponseEntity.ok(
                userGroupConversationService.addMembers(user.getUserId(), groupConversationId, modifyGroupMemberRequest)
        );
    }
    ...
    public ResponseEntity<Map<String, String>> remove(
        ...
        return ResponseEntity.ok(
                userGroupConversationService.removeMembers(user.getUserId(), groupConversationId, modifyGroupMemberRequest)
        );
    }
    ...
    public ResponseEntity<Map<String, String>> modifyRole(
        ...
        return ResponseEntity.ok(
                userGroupConversationService.modifyRoleMembers(user.getUserId(), groupConversationId, modifyRoleRequest)
        );
    }
