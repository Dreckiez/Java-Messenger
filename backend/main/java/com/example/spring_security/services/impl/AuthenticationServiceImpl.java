...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public Map<String, String> createVerificationToken(VerificationRequest verificationRequest) {
        ...
        String link = "http://localhost:8080/api/v1/auth/verify?token=" + newToken;
    ...
    public Map<String, String> resetPassword(VerificationRequest verificationRequest) {
        ...
        LocalDateTime now = LocalDateTime.now();
        if(passwordResetToken.getId() != null && passwordResetToken.getDateTimeCreated() != null &&
                passwordResetToken.getDateTimeCreated().plusDays(10).isAfter(now)) {
        ...
        passwordResetToken.setDateTimeCreated(now);
        passwordResetToken.setToken(generatedPassword);
